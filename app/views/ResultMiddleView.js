templates.resultMiddleView = "app/views/ResultMiddleView.html";

window.ResultMiddleView = Backbone.View.extend({
    ...
    render:function (eventName) {
        var template = _.template(templates.resultMiddleView);
